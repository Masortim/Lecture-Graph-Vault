...
| Lecture Graph | `lecture-graph` | 1.12.0 | сам граф: движки раскладки (`fdp` / `neato` / `twopi` / «кластеры по главам»), двухстрочные подписи без наложений (длинное название не обрезается, а плавно гаснет к краю; под курсором видно целиком), размер по ссылкам, фильтры, пузырёк сообщения у вершины, легенда цветов глав, экспорт SVG/CSV/JSON, оглавление курса (команда палитры или правый клик в «Проводнике»), создание новых вершин правым кликом по холсту (EN / 中文 / ключевые слова) с автопоиском связанных тем и связями со всеми главами, где встречаются ключевые фразы, ручные связи между вершинами (ЛКМ по первой, `Ctrl`+ЛКМ по второй — дуга рисуется автоматически), удаление выделенной вершины клавишей `Delete` или из панели/меню — со снятием ссылок, перевешиванием детей, корзиной и отменой, ручное слияние любых двух совместимых узлов через поиск по списку с выбором keeper и планом последствий, умное слияние дубликатов по вершине и по всему графу из меню пустого холста — с предпросмотром и отменой |
