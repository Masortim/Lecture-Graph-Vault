...
| Lecture Graph | `lecture-graph` | 1.10.1 | сам граф: движки раскладки (`fdp` / `neato` / `twopi` / «кластеры по главам»), двухстрочные подписи без наложений, размер по ссылкам, фильтры, пузырёк сообщения у вершины, легенда цветов глав, экспорт SVG/CSV/JSON, оглавление курса (команда палитры или правый клик в «Проводнике»), создание новых вершин правым кликом по холсту (EN / 中文 / ключевые слова) с автопоиском связанных тем, ручные связи между вершинами (ЛКМ по первой, `Ctrl`+ЛКМ по второй — дуга рисуется автоматически), удаление выделенной вершины клавишей `Delete` или из панели/меню — со снятием ссылок, перевешиванием детей, корзиной и отменой, умное слияние дубликатов по вершине и по всему графу из меню пустого холста — с предпросмотром, выбором keeper и отменой |
