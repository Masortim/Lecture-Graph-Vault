...
type: block
id: Ch05-S04-H05-B03
name: "Spectral Gap Estimate 5.4.5c"
name_zh: "谱隙估计 5.4.5c"
keywords_en: "spectral gap; fixed point"
aliases: ["Ch05-S04-H05-B03"]
status: placeholder
parent: Ch05-S04-H05
chapter: Ch05
...
# Spectral Gap Estimate 5.4.5c

**谱隙估计 5.4.5c** · estimate · 5.4.5c

⬆️ Part of [[Ch05-S04-H05 - Main Theorem Spectral Gap|Main Theorem: Spectral Gap]] · [[Ch05-S04-H05 - Main Theorem Spectral Gap|谱隙：主定理]]
...
Used together with: [[Ch08-S04-H03-B02 - Example 8.4.3b|Example 8.4.3b]], [[Ch01-S01-H02-B01 - Identity 1.1.2a|Identity 1.1.2a]].

<!-- keywords:begin -->

Связи по `keywords_en` (spectral gap, fixed point) — найдено в аннотациях `35 - Abstracts`. Число после × — вес ребра (сколько раз фраза встречается в этой области); блок создан алгоритмом, править его руками бессмысленно: перезапишется.
