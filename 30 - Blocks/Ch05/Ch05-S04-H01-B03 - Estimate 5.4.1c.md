...
type: block
id: Ch05-S04-H01-B03
name: "Feature Map Estimate 5.4.1c"
name_zh: "特征映射估计 5.4.1c"
keywords_en: "feature map; norm equivalence"
aliases: ["Ch05-S04-H01-B03"]
status: placeholder
parent: Ch05-S04-H01
chapter: Ch05
...
# Feature Map Estimate 5.4.1c

**特征映射估计 5.4.1c** · estimate · 5.4.1c

⬆️ Part of [[Ch05-S04-H01 - Definition Feature Map|Definition: Feature Map]] · [[Ch05-S04-H01 - Definition Feature Map|特征映射：定义]]
...
Used together with: [[Ch07-S03-H05-B02 - Identity 7.3.5b|Identity 7.3.5b]], [[Ch08-S04-H04-B01 - Example 8.4.4a|Example 8.4.4a]].
...
Связи по `keywords_en` (feature map, norm equivalence) — найдено в аннотациях `35 - Abstracts`. Число после × — вес ребра (сколько раз фраза встречается в этой области); блок создан алгоритмом, править его руками бессмысленно: перезапишется.
