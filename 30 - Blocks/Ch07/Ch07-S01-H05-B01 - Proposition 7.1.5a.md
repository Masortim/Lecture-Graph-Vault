...
type: block
id: Ch07-S01-H05-B01
name: "Entropy Bound Proposition 7.1.5a"
name_zh: "熵界命题 7.1.5a"
keywords_en: "entropy bound; uniform boundedness"
aliases: ["Ch07-S01-H05-B01"]
status: placeholder
parent: Ch07-S01-H05
chapter: Ch07
...
# Entropy Bound Proposition 7.1.5a

**熵界命题 7.1.5a** · statement · 7.1.5a

⬆️ Part of [[Ch07-S01-H05 - Main Theorem Entropy Bound|Main Theorem: Entropy Bound]] · [[Ch07-S01-H05 - Main Theorem Entropy Bound|熵界：主定理]]
...
**Вес по ключевым фразам: 20 · глава Ch07 (текст до первого `##` — связь с секцией, текст под `## Имя` — с заголовком)**
<!-- keywords:end -->
