...
type: block
id: Ch02-S03-H06-B03
name: "Linear Operator Example 2.3.6c"
name_zh: "线性算子例子 2.3.6c"
keywords_en: "linear operator"
aliases: ["Ch02-S03-H06-B03"]
status: placeholder
parent: Ch02-S03-H06
chapter: Ch02
...
# Linear Operator Example 2.3.6c

**线性算子例子 2.3.6c** · example · 2.3.6c

⬆️ Part of [[Ch02-S03-H06 - Proof and Consequences Linear Operator|Proof and Consequences: Linear Operator]] · [[Ch02-S03-H06 - Proof and Consequences Linear Operator|线性算子：证明与推论]]
...
**Вес по ключевым фразам: 16 · глава Ch02 (текст до первого `##` — связь с секцией, текст под `## Имя` — с заголовком)**
<!-- keywords:end -->
