...
type: block
id: Ch09-S03-H06-B03
name: "Norm Equivalence Example 9.3.6c"
name_zh: "范数等价例子 9.3.6c"
keywords_en: "norm equivalence"
aliases: ["Ch09-S03-H06-B03"]
status: placeholder
parent: Ch09-S03-H06
chapter: Ch09
...
# Norm Equivalence Example 9.3.6c

**范数等价例子 9.3.6c** · example · 9.3.6c

⬆️ Part of [[Ch09-S03-H06 - Proof and Consequences Norm Equivalence|Proof and Consequences: Norm Equivalence]] · [[Ch09-S03-H06 - Proof and Consequences Norm Equivalence|范数等价：证明与推论]]
...
Used together with: [[Ch08-S02-H04-B02 - Proposition 8.2.4b|Proposition 8.2.4b]], [[Ch09-S03-H03-B02 - Example 9.3.3b|Example 9.3.3b]].
...
Связи по `keywords_en` (norm equivalence) — найдено в аннотациях `35 - Abstracts`. Число после × — вес ребра (сколько раз фраза встречается в этой области); блок создан алгоритмом, править его руками бессмысленно: перезапишется.
...
**Вес по ключевым фразам: 13 · глава Ch01 (текст до первого `##` — связь с секцией, текст под `## Имя` — с заголовком)**
<!-- keywords:end -->
