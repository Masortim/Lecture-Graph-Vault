...
9 глав · 36 секций · 216 заголовков · 756 блоков · 8435 ссылок в графе · 1017 вершин
*пересобрано: 2026-09-14 04:08*
...
> >
> > > [!heading]+ 🟢 [[Ch01-S01-H01 - Definition Vector Space|Definition: Vector Space]] · 向量空间：定义 · `⇠ 51` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S01-H02 - Notation Linear Operator|Notation: Linear Operator]] · 线性算子：记号约定 · `⇠ 25` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S01-H03 - Basic Properties Compact Set|Basic Properties: Compact Set]] · 紧集：基本性质 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S01-H04 - Key Lemma Metric Completion|Key Lemma: Metric Completion]] · 度量完备化：关键引理 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S01-H05 - Main Theorem Orthogonal Projection|Main Theorem: Orthogonal Projection]] · 正交投影：主定理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S01-H06 - Proof and Consequences Basis and Coordinates|Proof and Consequences: Basis and Coordinates]] · 基与坐标：证明与推论 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S02-H01 - Definition Dual Space|Definition: Dual Space]] · 对偶空间：定义 · `⇠ 37` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S02-H02 - Notation Adjoint Operator|Notation: Adjoint Operator]] · 伴随算子：记号约定 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S02-H03 - Basic Properties Spectral Theorem|Basic Properties: Spectral Theorem]] · 谱定理：基本性质 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S02-H04 - Key Lemma Norm Equivalence|Key Lemma: Norm Equivalence]] · 范数等价：关键引理 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S02-H05 - Main Theorem Contraction Mapping|Main Theorem: Contraction Mapping]] · 压缩映射：主定理 · `⇠ 37` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S02-H06 - Proof and Consequences Fixed Point|Proof and Consequences: Fixed Point]] · 不动点：证明与推论 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S03-H01 - Definition Banach Limit|Definition: Banach Limit]] · 巴拿赫极限：定义 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S03-H02 - Notation Hilbert Decomposition|Notation: Hilbert Decomposition]] · 希尔伯特分解：记号约定 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S03-H03 - Basic Properties Weak Convergence|Basic Properties: Weak Convergence]] · 弱收敛：基本性质 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S03-H04 - Key Lemma Density Argument|Key Lemma: Density Argument]] · 稠密性论证：关键引理 · `⇠ 30` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S03-H05 - Main Theorem Kernel and Range|Main Theorem: Kernel and Range]] · 核与值域：主定理 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S03-H06 - Proof and Consequences Eigenvalue Bounds|Proof and Consequences: Eigenvalue Bounds]] · 特征值估计：证明与推论 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S04-H01 - Definition Singular Values|Definition: Singular Values]] · 奇异值：定义 · `⇠ 34` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S04-H02 - Notation Trace Class|Notation: Trace Class]] · 迹类：记号约定 · `⇠ 12` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S04-H03 - Basic Properties Convex Hull|Basic Properties: Convex Hull]] · 凸包：基本性质 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S04-H04 - Key Lemma Separation Theorem|Key Lemma: Separation Theorem]] · 分离定理：关键引理 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch01-S04-H05 - Main Theorem Hahn-Banach Extension|Main Theorem: Hahn-Banach Extension]] · 哈恩-巴拿赫延拓：主定理 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch01-S04-H06 - Proof and Consequences Open Mapping|Proof and Consequences: Open Mapping]] · 开映射：证明与推论 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S01-H01 - Definition Closed Graph|Definition: Closed Graph]] · 闭图像：定义 · `⇠ 32` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S01-H02 - Notation Uniform Boundedness|Notation: Uniform Boundedness]] · 一致有界性：记号约定 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S01-H03 - Basic Properties Approximation Error|Basic Properties: Approximation Error]] · 逼近误差：基本性质 · `⇠ 34` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S01-H04 - Key Lemma Radon-Nikodym Derivative|Key Lemma: Radon-Nikodym Derivative]] · 拉东-尼科迪姆导数：关键引理 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S01-H05 - Main Theorem Entropy Bound|Main Theorem: Entropy Bound]] · 熵界：主定理 · `⇠ 37` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S01-H06 - Proof and Consequences Concentration Inequality|Proof and Consequences: Concentration Inequality]] · 集中不等式：证明与推论 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S02-H01 - Definition Gradient Descent|Definition: Gradient Descent]] · 梯度下降：定义 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S02-H02 - Notation Lipschitz Continuity|Notation: Lipschitz Continuity]] · 利普希茨连续性：记号约定 · `⇠ 25` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S02-H03 - Basic Properties Duality Gap|Basic Properties: Duality Gap]] · 对偶间隙：基本性质 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S02-H04 - Key Lemma Regularization|Key Lemma: Regularization]] · 正则化：关键引理 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S02-H05 - Main Theorem Feature Map|Main Theorem: Feature Map]] · 特征映射：主定理 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S02-H06 - Proof and Consequences Kernel Matrix|Proof and Consequences: Kernel Matrix]] · 核矩阵：证明与推论 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S03-H01 - Definition Sample Complexity|Definition: Sample Complexity]] · 样本复杂度：定义 · `⇠ 41` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S03-H02 - Notation Generalization Bound|Notation: Generalization Bound]] · 泛化界：记号约定 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S03-H03 - Basic Properties Spectral Gap|Basic Properties: Spectral Gap]] · 谱隙：基本性质 · `⇠ 34` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S03-H04 - Key Lemma Markov Chain|Key Lemma: Markov Chain]] · 马尔可夫链：关键引理 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S03-H05 - Main Theorem Vector Space|Main Theorem: Vector Space]] · 向量空间：主定理 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S03-H06 - Proof and Consequences Linear Operator|Proof and Consequences: Linear Operator]] · 线性算子：证明与推论 · `⇠ 41` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S04-H01 - Definition Compact Set|Definition: Compact Set]] · 紧集：定义 · `⇠ 30` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S04-H02 - Notation Metric Completion|Notation: Metric Completion]] · 度量完备化：记号约定 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S04-H03 - Basic Properties Orthogonal Projection|Basic Properties: Orthogonal Projection]] · 正交投影：基本性质 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S04-H04 - Key Lemma Basis and Coordinates|Key Lemma: Basis and Coordinates]] · 基与坐标：关键引理 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch02-S04-H05 - Main Theorem Dual Space|Main Theorem: Dual Space]] · 对偶空间：主定理 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch02-S04-H06 - Proof and Consequences Adjoint Operator|Proof and Consequences: Adjoint Operator]] · 伴随算子：证明与推论 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S01-H01 - Definition Spectral Theorem|Definition: Spectral Theorem]] · 谱定理：定义 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S01-H02 - Notation Norm Equivalence|Notation: Norm Equivalence]] · 范数等价：记号约定 · `⇠ 33` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S01-H03 - Basic Properties Contraction Mapping|Basic Properties: Contraction Mapping]] · 压缩映射：基本性质 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S01-H04 - Key Lemma Fixed Point|Key Lemma: Fixed Point]] · 不动点：关键引理 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S01-H05 - Main Theorem Banach Limit|Main Theorem: Banach Limit]] · 巴拿赫极限：主定理 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S01-H06 - Proof and Consequences Hilbert Decomposition|Proof and Consequences: Hilbert Decomposition]] · 希尔伯特分解：证明与推论 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S02-H01 - Definition Weak Convergence|Definition: Weak Convergence]] · 弱收敛：定义 · `⇠ 33` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S02-H02 - Notation Density Argument|Notation: Density Argument]] · 稠密性论证：记号约定 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S02-H03 - Basic Properties Kernel and Range|Basic Properties: Kernel and Range]] · 核与值域：基本性质 · `⇠ 14` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S02-H04 - Key Lemma Eigenvalue Bounds|Key Lemma: Eigenvalue Bounds]] · 特征值估计：关键引理 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S02-H05 - Main Theorem Singular Values|Main Theorem: Singular Values]] · 奇异值：主定理 · `⇠ 31` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S02-H06 - Proof and Consequences Trace Class|Proof and Consequences: Trace Class]] · 迹类：证明与推论 · `⇠ 12` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S03-H01 - Definition Convex Hull|Definition: Convex Hull]] · 凸包：定义 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S03-H02 - Notation Separation Theorem|Notation: Separation Theorem]] · 分离定理：记号约定 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S03-H03 - Basic Properties Hahn-Banach Extension|Basic Properties: Hahn-Banach Extension]] · 哈恩-巴拿赫延拓：基本性质 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S03-H04 - Key Lemma Open Mapping|Key Lemma: Open Mapping]] · 开映射：关键引理 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S03-H05 - Main Theorem Closed Graph|Main Theorem: Closed Graph]] · 闭图像：主定理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S03-H06 - Proof and Consequences Uniform Boundedness|Proof and Consequences: Uniform Boundedness]] · 一致有界性：证明与推论 · `⇠ 25` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S04-H01 - Definition Approximation Error|Definition: Approximation Error]] · 逼近误差：定义 · `⇠ 41` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S04-H02 - Notation Radon-Nikodym Derivative|Notation: Radon-Nikodym Derivative]] · 拉东-尼科迪姆导数：记号约定 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S04-H03 - Basic Properties Entropy Bound|Basic Properties: Entropy Bound]] · 熵界：基本性质 · `⇠ 36` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S04-H04 - Key Lemma Concentration Inequality|Key Lemma: Concentration Inequality]] · 集中不等式：关键引理 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch03-S04-H05 - Main Theorem Gradient Descent|Main Theorem: Gradient Descent]] · 梯度下降：主定理 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch03-S04-H06 - Proof and Consequences Lipschitz Continuity|Proof and Consequences: Lipschitz Continuity]] · 利普希茨连续性：证明与推论 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S01-H01 - Definition Duality Gap|Definition: Duality Gap]] · 对偶间隙：定义 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S01-H02 - Notation Regularization|Notation: Regularization]] · 正则化：记号约定 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S01-H03 - Basic Properties Feature Map|Basic Properties: Feature Map]] · 特征映射：基本性质 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S01-H04 - Key Lemma Kernel Matrix|Key Lemma: Kernel Matrix]] · 核矩阵：关键引理 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S01-H05 - Main Theorem Sample Complexity|Main Theorem: Sample Complexity]] · 样本复杂度：主定理 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S01-H06 - Proof and Consequences Generalization Bound|Proof and Consequences: Generalization Bound]] · 泛化界：证明与推论 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S02-H01 - Definition Spectral Gap|Definition: Spectral Gap]] · 谱隙：定义 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S02-H02 - Notation Markov Chain|Notation: Markov Chain]] · 马尔可夫链：记号约定 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S02-H03 - Basic Properties Vector Space|Basic Properties: Vector Space]] · 向量空间：基本性质 · `⇠ 14` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S02-H04 - Key Lemma Linear Operator|Key Lemma: Linear Operator]] · 线性算子：关键引理 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S02-H05 - Main Theorem Compact Set|Main Theorem: Compact Set]] · 紧集：主定理 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S02-H06 - Proof and Consequences Metric Completion|Proof and Consequences: Metric Completion]] · 度量完备化：证明与推论 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S03-H01 - Definition Orthogonal Projection|Definition: Orthogonal Projection]] · 正交投影：定义 · `⇠ 41` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S03-H02 - Notation Basis and Coordinates|Notation: Basis and Coordinates]] · 基与坐标：记号约定 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S03-H03 - Basic Properties Dual Space|Basic Properties: Dual Space]] · 对偶空间：基本性质 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S03-H04 - Key Lemma Adjoint Operator|Key Lemma: Adjoint Operator]] · 伴随算子：关键引理 · `⇠ 14` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S03-H05 - Main Theorem Spectral Theorem|Main Theorem: Spectral Theorem]] · 谱定理：主定理 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S03-H06 - Proof and Consequences Norm Equivalence|Proof and Consequences: Norm Equivalence]] · 范数等价：证明与推论 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S04-H01 - Definition Contraction Mapping|Definition: Contraction Mapping]] · 压缩映射：定义 · `⇠ 49` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S04-H02 - Notation Fixed Point|Notation: Fixed Point]] · 不动点：记号约定 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S04-H03 - Basic Properties Banach Limit|Basic Properties: Banach Limit]] · 巴拿赫极限：基本性质 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S04-H04 - Key Lemma Hilbert Decomposition|Key Lemma: Hilbert Decomposition]] · 希尔伯特分解：关键引理 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch04-S04-H05 - Main Theorem Weak Convergence|Main Theorem: Weak Convergence]] · 弱收敛：主定理 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch04-S04-H06 - Proof and Consequences Density Argument|Proof and Consequences: Density Argument]] · 稠密性论证：证明与推论 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S01-H01 - Definition Vector Space|Definition: Vector Space]] · 向量空间：定义 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S01-H02 - Notation Linear Operator|Notation: Linear Operator]] · 线性算子：记号约定 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S01-H03 - Basic Properties Compact Set|Basic Properties: Compact Set]] · 紧集：基本性质 · `⇠ 30` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S01-H04 - Key Lemma Metric Completion|Key Lemma: Metric Completion]] · 度量完备化：关键引理 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S01-H05 - Main Theorem Orthogonal Projection|Main Theorem: Orthogonal Projection]] · 正交投影：主定理 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S01-H06 - Proof and Consequences Basis and Coordinates|Proof and Consequences: Basis and Coordinates]] · 基与坐标：证明与推论 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S02-H01 - Definition Dual Space|Definition: Dual Space]] · 对偶空间：定义 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S02-H02 - Notation Adjoint Operator|Notation: Adjoint Operator]] · 伴随算子：记号约定 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S02-H03 - Basic Properties Spectral Theorem|Basic Properties: Spectral Theorem]] · 谱定理：基本性质 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S02-H04 - Key Lemma Norm Equivalence|Key Lemma: Norm Equivalence]] · 范数等价：关键引理 · `⇠ 34` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S02-H05 - Main Theorem Contraction Mapping|Main Theorem: Contraction Mapping]] · 压缩映射：主定理 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S02-H06 - Proof and Consequences Fixed Point|Proof and Consequences: Fixed Point]] · 不动点：证明与推论 · `⇠ 37` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S03-H01 - Definition Banach Limit|Definition: Banach Limit]] · 巴拿赫极限：定义 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S03-H02 - Notation Hilbert Decomposition|Notation: Hilbert Decomposition]] · 希尔伯特分解：记号约定 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S03-H03 - Basic Properties Weak Convergence|Basic Properties: Weak Convergence]] · 弱收敛：基本性质 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S03-H04 - Key Lemma Density Argument|Key Lemma: Density Argument]] · 稠密性论证：关键引理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S03-H05 - Main Theorem Kernel and Range|Main Theorem: Kernel and Range]] · 核与值域：主定理 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S03-H06 - Proof and Consequences Eigenvalue Bounds|Proof and Consequences: Eigenvalue Bounds]] · 特征值估计：证明与推论 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S04-H01 - Definition Singular Values|Definition: Singular Values]] · 奇异值：定义 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S04-H02 - Notation Trace Class|Notation: Trace Class]] · 迹类：记号约定 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S04-H03 - Basic Properties Convex Hull|Basic Properties: Convex Hull]] · 凸包：基本性质 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S04-H04 - Key Lemma Separation Theorem|Key Lemma: Separation Theorem]] · 分离定理：关键引理 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch06-S04-H05 - Main Theorem Hahn-Banach Extension|Main Theorem: Hahn-Banach Extension]] · 哈恩-巴拿赫延拓：主定理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch06-S04-H06 - Proof and Consequences Open Mapping|Proof and Consequences: Open Mapping]] · 开映射：证明与推论 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S01-H01 - Definition Closed Graph|Definition: Closed Graph]] · 闭图像：定义 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S01-H02 - Notation Uniform Boundedness|Notation: Uniform Boundedness]] · 一致有界性：记号约定 · `⇠ 25` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S01-H03 - Basic Properties Approximation Error|Basic Properties: Approximation Error]] · 逼近误差：基本性质 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S01-H04 - Key Lemma Radon-Nikodym Derivative|Key Lemma: Radon-Nikodym Derivative]] · 拉东-尼科迪姆导数：关键引理 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S01-H05 - Main Theorem Entropy Bound|Main Theorem: Entropy Bound]] · 熵界：主定理 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S01-H06 - Proof and Consequences Concentration Inequality|Proof and Consequences: Concentration Inequality]] · 集中不等式：证明与推论 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S02-H01 - Definition Gradient Descent|Definition: Gradient Descent]] · 梯度下降：定义 · `⇠ 36` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S02-H02 - Notation Lipschitz Continuity|Notation: Lipschitz Continuity]] · 利普希茨连续性：记号约定 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S02-H03 - Basic Properties Duality Gap|Basic Properties: Duality Gap]] · 对偶间隙：基本性质 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S02-H04 - Key Lemma Regularization|Key Lemma: Regularization]] · 正则化：关键引理 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S02-H05 - Main Theorem Feature Map|Main Theorem: Feature Map]] · 特征映射：主定理 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S02-H06 - Proof and Consequences Kernel Matrix|Proof and Consequences: Kernel Matrix]] · 核矩阵：证明与推论 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S03-H01 - Definition Sample Complexity|Definition: Sample Complexity]] · 样本复杂度：定义 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S03-H02 - Notation Generalization Bound|Notation: Generalization Bound]] · 泛化界：记号约定 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S03-H03 - Basic Properties Spectral Gap|Basic Properties: Spectral Gap]] · 谱隙：基本性质 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S03-H04 - Key Lemma Markov Chain|Key Lemma: Markov Chain]] · 马尔可夫链：关键引理 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S03-H05 - Main Theorem Vector Space|Main Theorem: Vector Space]] · 向量空间：主定理 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S03-H06 - Proof and Consequences Linear Operator|Proof and Consequences: Linear Operator]] · 线性算子：证明与推论 · `⇠ 25` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S04-H01 - Definition Compact Set|Definition: Compact Set]] · 紧集：定义 · `⇠ 37` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S04-H02 - Notation Metric Completion|Notation: Metric Completion]] · 度量完备化：记号约定 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S04-H03 - Basic Properties Orthogonal Projection|Basic Properties: Orthogonal Projection]] · 正交投影：基本性质 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S04-H04 - Key Lemma Basis and Coordinates|Key Lemma: Basis and Coordinates]] · 基与坐标：关键引理 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch07-S04-H05 - Main Theorem Dual Space|Main Theorem: Dual Space]] · 对偶空间：主定理 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch07-S04-H06 - Proof and Consequences Adjoint Operator|Proof and Consequences: Adjoint Operator]] · 伴随算子：证明与推论 · `⇠ 13` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S01-H01 - Definition Spectral Theorem|Definition: Spectral Theorem]] · 谱定理：定义 · `⇠ 35` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S01-H02 - Notation Norm Equivalence|Notation: Norm Equivalence]] · 范数等价：记号约定 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S01-H03 - Basic Properties Contraction Mapping|Basic Properties: Contraction Mapping]] · 压缩映射：基本性质 · `⇠ 36` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S01-H04 - Key Lemma Fixed Point|Key Lemma: Fixed Point]] · 不动点：关键引理 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S01-H05 - Main Theorem Banach Limit|Main Theorem: Banach Limit]] · 巴拿赫极限：主定理 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S01-H06 - Proof and Consequences Hilbert Decomposition|Proof and Consequences: Hilbert Decomposition]] · 希尔伯特分解：证明与推论 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S02-H01 - Definition Weak Convergence|Definition: Weak Convergence]] · 弱收敛：定义 · `⇠ 31` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S02-H02 - Notation Density Argument|Notation: Density Argument]] · 稠密性论证：记号约定 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S02-H03 - Basic Properties Kernel and Range|Basic Properties: Kernel and Range]] · 核与值域：基本性质 · `⇠ 12` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S02-H04 - Key Lemma Eigenvalue Bounds|Key Lemma: Eigenvalue Bounds]] · 特征值估计：关键引理 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S02-H05 - Main Theorem Singular Values|Main Theorem: Singular Values]] · 奇异值：主定理 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S02-H06 - Proof and Consequences Trace Class|Proof and Consequences: Trace Class]] · 迹类：证明与推论 · `⇠ 15` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S03-H01 - Definition Convex Hull|Definition: Convex Hull]] · 凸包：定义 · `⇠ 27` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S03-H02 - Notation Separation Theorem|Notation: Separation Theorem]] · 分离定理：记号约定 · `⇠ 12` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S03-H03 - Basic Properties Hahn-Banach Extension|Basic Properties: Hahn-Banach Extension]] · 哈恩-巴拿赫延拓：基本性质 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S03-H04 - Key Lemma Open Mapping|Key Lemma: Open Mapping]] · 开映射：关键引理 · `⇠ 14` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S03-H05 - Main Theorem Closed Graph|Main Theorem: Closed Graph]] · 闭图像：主定理 · `⇠ 29` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S03-H06 - Proof and Consequences Uniform Boundedness|Proof and Consequences: Uniform Boundedness]] · 一致有界性：证明与推论 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S04-H01 - Definition Approximation Error|Definition: Approximation Error]] · 逼近误差：定义 · `⇠ 26` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S04-H02 - Notation Radon-Nikodym Derivative|Notation: Radon-Nikodym Derivative]] · 拉东-尼科迪姆导数：记号约定 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S04-H03 - Basic Properties Entropy Bound|Basic Properties: Entropy Bound]] · 熵界：基本性质 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S04-H04 - Key Lemma Concentration Inequality|Key Lemma: Concentration Inequality]] · 集中不等式：关键引理 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch08-S04-H05 - Main Theorem Gradient Descent|Main Theorem: Gradient Descent]] · 梯度下降：主定理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch08-S04-H06 - Proof and Consequences Lipschitz Continuity|Proof and Consequences: Lipschitz Continuity]] · 利普希茨连续性：证明与推论 · `⇠ 25` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S01-H01 - Definition Duality Gap|Definition: Duality Gap]] · 对偶间隙：定义 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S01-H02 - Notation Regularization|Notation: Regularization]] · 正则化：记号约定 · `⇠ 21` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S01-H03 - Basic Properties Feature Map|Basic Properties: Feature Map]] · 特征映射：基本性质 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S01-H04 - Key Lemma Kernel Matrix|Key Lemma: Kernel Matrix]] · 核矩阵：关键引理 · `⇠ 24` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S01-H05 - Main Theorem Sample Complexity|Main Theorem: Sample Complexity]] · 样本复杂度：主定理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S01-H06 - Proof and Consequences Generalization Bound|Proof and Consequences: Generalization Bound]] · 泛化界：证明与推论 · `⇠ 17` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S02-H01 - Definition Spectral Gap|Definition: Spectral Gap]] · 谱隙：定义 · `⇠ 39` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S02-H02 - Notation Markov Chain|Notation: Markov Chain]] · 马尔可夫链：记号约定 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S02-H03 - Basic Properties Vector Space|Basic Properties: Vector Space]] · 向量空间：基本性质 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S02-H04 - Key Lemma Linear Operator|Key Lemma: Linear Operator]] · 线性算子：关键引理 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S02-H05 - Main Theorem Compact Set|Main Theorem: Compact Set]] · 紧集：主定理 · `⇠ 31` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S02-H06 - Proof and Consequences Metric Completion|Proof and Consequences: Metric Completion]] · 度量完备化：证明与推论 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S03-H01 - Definition Orthogonal Projection|Definition: Orthogonal Projection]] · 正交投影：定义 · `⇠ 28` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S03-H02 - Notation Basis and Coordinates|Notation: Basis and Coordinates]] · 基与坐标：记号约定 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S03-H03 - Basic Properties Dual Space|Basic Properties: Dual Space]] · 对偶空间：基本性质 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S03-H04 - Key Lemma Adjoint Operator|Key Lemma: Adjoint Operator]] · 伴随算子：关键引理 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S03-H05 - Main Theorem Spectral Theorem|Main Theorem: Spectral Theorem]] · 谱定理：主定理 · `⇠ 20` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S03-H06 - Proof and Consequences Norm Equivalence|Proof and Consequences: Norm Equivalence]] · 范数等价：证明与推论 · `⇠ 33` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S04-H01 - Definition Contraction Mapping|Definition: Contraction Mapping]] · 压缩映射：定义 · `⇠ 43` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S04-H02 - Notation Fixed Point|Notation: Fixed Point]] · 不动点：记号约定 · `⇠ 18` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S04-H03 - Basic Properties Banach Limit|Basic Properties: Banach Limit]] · 巴拿赫极限：基本性质 · `⇠ 22` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S04-H04 - Key Lemma Hilbert Decomposition|Key Lemma: Hilbert Decomposition]] · 希尔伯特分解：关键引理 · `⇠ 16` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
> >
> > > [!heading]+ 🟢 [[Ch09-S04-H05 - Main Theorem Weak Convergence|Main Theorem: Weak Convergence]] · 弱收敛：主定理 · `⇠ 23` · `◌`
> > >
> > > > [!block] 🟣 блоков · 4
...
> >
> > > [!heading]+ 🟢 [[Ch09-S04-H06 - Proof and Consequences Density Argument|Proof and Consequences: Density Argument]] · 稠密性论证：证明与推论 · `⇠ 19` · `◌`
> > >
> > > > [!block] 🟣 блоков · 3
...
| [[Ch01-S01-H01 - Definition Vector Space]] | Definition: Vector Space | heading | 向量空间：定义 | `51` | 51 | 4 | 0 |
...
| [[Ch04-S04-H01 - Definition Contraction Mapping]] | Definition: Contraction Mapping | heading | 压缩映射：定义 | `49` | 49 | 4 | 0 |
| [[Ch01 - Metric Spaces and Completion]] | Metric Spaces and Completion | chapter | 度量空间与完备化 | `48` | 48 | 4 | 0 |
| [[Ch03-S04 - Applications and Limits]] | Applications and Limits — Inner Products and Orthogonality | section | 内积与正交性：应用与局限 | `46` | 46 | 6 | 0 |
| [[Ch03-S01 - Setup and Notation]] | Setup and Notation — Inner Products and Orthogonality | section | 内积与正交性：预备知识与记号 | `45` | 45 | 6 | 0 |
| [[Ch09-S04-H01 - Definition Contraction Mapping]] | Definition: Contraction Mapping | heading | 压缩映射：定义 | `43` | 43 | 4 | 0 |
| [[Ch02-S03-H01 - Definition Sample Complexity]] | Definition: Sample Complexity | heading | 样本复杂度：定义 | `41` | 41 | 4 | 0 |
| [[Ch02-S03-H06 - Proof and Consequences Linear Operator]] | Proof and Consequences: Linear Operator | heading | 线性算子：证明与推论 | `41` | 41 | 3 | 0 |
| [[Ch03-S04-H01 - Definition Approximation Error]] | Definition: Approximation Error | heading | 逼近误差：定义 | `41` | 41 | 4 | 0 |
| [[Ch04-S03-H01 - Definition Orthogonal Projection]] | Definition: Orthogonal Projection | heading | 正交投影：定义 | `41` | 41 | 4 | 0 |
| [[Ch06-S01 - Setup and Notation]] | Setup and Notation — Spectral Theory | section | 谱理论：预备知识与记号 | `41` | 41 | 6 | 0 |
| [[Ch09-S04 - Applications and Limits]] | Applications and Limits — Learning Theory and Regularization | section | 学习理论与正则化：应用与局限 | `41` | 41 | 6 | 0 |
| [[Ch03-S03 - Main Results]] | Main Results — Inner Products and Orthogonality | section | 内积与正交性：主要结果 | `40` | 40 | 6 | 0 |
